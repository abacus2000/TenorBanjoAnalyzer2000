...
//      public ChordDiagram(List<Integer> frets, 
...
//                     return Integer.compare(a.getOctave(), b.getOctave());
//                 }
//                 return Integer.compare(Arrays.asList(NOTES).indexOf(a.getName()), 
//                                     Arrays.asList(NOTES).indexOf(b.getName()));
//             });
//             return result;
//         }
